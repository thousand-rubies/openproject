...
gem 'sprockets', '~> 4.2.0' # lock sprockets below 4.0
...
gem "appsignal", "~> 3.1", ">= 3.1.5", require: false
...
group :test do
  ...
  gem 'rspec-rails', '~> 6.0.1', group: :development
  ...
  gem 'json_spec', '~> 1.1.4'
  gem 'shoulda-matchers', '~> 5.2', '>= 5.2.0', require: nil
